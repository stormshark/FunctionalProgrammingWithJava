...
import dev.kaldiroglu.fpj.ch03.domain.BookFactory;
...
public class FunctionExample {
	...
	public static void functionExample() {
		...
		String resultString = converter.apply(17423426);
		System.out.println("length of 17423426: " + resultString.length());
